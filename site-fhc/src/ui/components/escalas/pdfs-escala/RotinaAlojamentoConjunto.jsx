...
const RotinaAlojamentoConjunto = () => {
    ...
    useEffect(() => {
        async function fetchData() {
            try {               
                const response = await fetch("https://hospitalcentenario.rs.gov.br/wp-json/wp/v2/pages/5940");
...
export default RotinaAlojamentoConjunto;
